...
const Hero = () => {
  return (
    <div id='hero' className='flex flex-col items-center gap-6 py-20 px-4 sm:px-12 lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white'>
      ...
      className='text-sm sm:text-lg font-medium text-gray-500 dark:text-white/75 max-w-4/5 sm:max-w-lg pb-3'>Creating meaningful digital experiences that connect brands with their audiences.</motion.p>
      ...
      className="relative">
        ...
        <img src={assets.hero_img} alt="hero" className='w-full max-w-6xl rounded-2xl' />
        <img src={assets.bgImage1} alt="bgimage-1" className='absolute -top-40 -right-40 sm:-top-100 sm:-right-70 -z-1 dark:hidden' />
      </motion.div>
    </div>
  )
}
